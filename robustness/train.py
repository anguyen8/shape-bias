...
def eval_model(args, model, loader, store, madry_model=True):
    """
    ...
    prec1, nat_loss = _model_loop(args, 'val', loader, 
                                        model, None, 0, False, writer, madry_model)
...
def _model_loop(args, loop_type, loader, model, opt, epoch, adv, writer, madry_model=True):
    """
